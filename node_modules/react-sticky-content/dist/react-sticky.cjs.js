...
var StickyBox = function (_React$Component) {
  ...
  function StickyBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = StickyBox.__proto__ || _Object$getPrototypeOf(StickyBox)).call.apply(_ref, [this].concat(args))), _this), _this.registerContainerRef = function (n) {
